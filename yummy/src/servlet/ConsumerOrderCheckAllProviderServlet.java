...
@WebServlet("/consumer/order/checkall/provider")
public class ConsumerOrderCheckAllProviderServlet extends HttpServlet {


	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		OrderStatisticsService service=new OrderStatisticsService();
		String cid=(String)request.getSession().getAttribute("cid");
		List<OrderForPresentVO> orderList=service.getListByProviderForConsumer(cid);
