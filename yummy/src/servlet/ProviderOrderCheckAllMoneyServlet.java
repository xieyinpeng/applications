...
@WebServlet("/provider/order/checkall/money")
public class ProviderOrderCheckAllMoneyServlet extends HttpServlet {

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String pid=(String)request.getSession().getAttribute("pid");
		OrderStatisticsService service=new OrderStatisticsService();
		List<OrderForPresentVO> orderList=service.getListByMoneyForProvider(pid);
