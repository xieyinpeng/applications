...
@WebServlet("/provider/order/checkall/date")
public class ProviderOrderCheckAllDateServlet extends HttpServlet {

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String pid=(String)request.getSession().getAttribute("pid");
		OrderStatisticsService service=new OrderStatisticsService();
		List<OrderForPresentVO> orderList=service.getListByDateForProvider(pid);
